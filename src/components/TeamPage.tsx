  ...
  const teamMembers = [
    {
      ...
      achievements: [
       ...
       contact: {
        email: "ifeanyiofodu@yahoo.com",
        phone: "+2348065620419",
        linkedin: "https://www.linkedin.com/in/ifeanyi-ofodu-226ba6150/",
        instagram: "https://www.instagram.com/raymondofodu/"
      }
    },
    {
    ...
    },
    {
      ...
      specializations: [
        ...
        "Youth Mobilization & Empowerment",
      ...
      achievements: [
        "Founder & CEO of SereniMind - Top 2 Mental Health Organization in Nigeria",
        "TVC Labs Fellow - Nigeria's top startup incubator",
        "Entrepreneur of the Year, Babcock University",
        "ALX Founder's Academy Graduate",
        "Project Management Certificate – University of California, Irvine  ",
        "1st Runner-Up in startup challenge (30 organizations)",
        "State Coordinator, Youth Creative Conference (YCC) Ogun State",
        "Director of Public Relations, Babcock University Students' Association",
        "Second Class Upper Graduate, Babcock University (24/25)",
        "Global Youth Ambassador, Theirworld",
        "Ambassador, AfriLead EduTourism Network",
        "Project Management Certificate - University of California, Irvine",
        "6+ years experience in full-stack development and AI solutions"
      ],
      contact: {
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12 py-16">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            ...
            education, technology, and community development to drive meaningful change across Africa and beyond.
          </p>
        </div>
    ...
    <div className="mb-4 sm:mb-0">
      ...
      {member.contact && (
        <div className="mt-2 text-sm text-gray-600 space-y-1">
          <a href={`mailto:${member.contact.email}`} className="block hover:underline" target="_blank" rel="noopener noreferrer">
            {member.contact.email}
          </a>
          <a href={`tel:${member.contact.phone}`} className="block hover:underline" target="_blank" rel="noopener noreferrer">
    ...
    <div className="flex space-x-3">
      {member.contact?.email && (
        <a
          ...
          className="p-3 bg-red-600 text-white rounded-full hover:bg-red-700 transition-colors duration-300 shadow-lg hover:shadow-xl"
          target="_blank"
      ...
      {member.contact?.linkedin && (
        <a
          ...
          className="p-3 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition-colors duration-300 shadow-lg hover:shadow-xl"
          target="_blank"
          rel="noopener noreferrer"
        >
          <Linkedin size={20} />
      ...
      {member.contact?.instagram && (
        <a
          ...
          className="p-3 bg-gray-600 text-white rounded-full hover:bg-gray-700 transition-colors duration-300 shadow-lg hover:shadow-xl"
          target="_blank"
          rel="noopener noreferrer"
        >
          <Globe size={20} />
          ...
          <div className="bg-gradient-to-r from-red-600 via-red-700 to-red-800 rounded-3xl p-12 lg:p-16 text-white shadow-2xl">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl text-red-100 leading-relaxed mb-8">
                ...
                education, technology innovation, and advocacy for the most vulnerable populations.
              </p>
